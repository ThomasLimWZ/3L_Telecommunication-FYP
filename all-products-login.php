<?php include("header-login.php"); ?>
		...
		<div class="container" style="text-align:center;">
			...
			<ul class="sorting">
				...
				<li id="child1" class="sort_child"><h6><a class="child_link" id="link1" href="all-products-login.php">Latest</a></h6></li>
		...
		<script>
			$(function() {
				$('#link2').click(function() {
					window.location.href = 'all-products-login.php?sortName&sort_type=<?php echo $new_sort_type;?>';
				});
			});
			$(function() {
				$('#link3').click(function() {
					window.location.href = 'all-products-login.php?sortPrice&sortPrice_type=<?php echo $new_sortPrice_type;?>';
				});
			});
		</script>
