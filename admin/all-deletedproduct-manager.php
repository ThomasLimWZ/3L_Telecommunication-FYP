            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Deleted Product </h1>
                    </div>
								...
								<div class="col-lg-12">
										...
										<div class="row formtype">
											<div class="col-md-3">
												<div class="form-group">
													<label>Brand &nbsp;</label> <a href="all-deletedproduct-manager.php"><i style="color:black;" class="fa">&#xf021;</i></a>
									...
									<form method="GET" action="">
										<div class="row formtype">
											<div class="col-md-3">
												<div class="form-group">
													<label>Category &nbsp;</label> <a href="all-deletedproduct-manager.php"><i style="color:black;" class="fa">&#xf021;</i></a>
									...
									<form method="GET" action="">
										...
										<div class="card-body">
											<table class="datatable table table-stripped table table-hover table-center mb-0" id="dataTable" width="100%" cellspacing="0">
												<?php
													if(isset($_GET["filterbtn"])){
														...
														$result = mysqli_query($connect, "SELECT * FROM product JOIN brand ON product.brand_name=brand.brand_name 
																						  WHERE product.brand_name='$brand_filter' AND product.product_status = 0 AND brand.brand_status=1");
												...
												?>
													<tr>
														<td><input type="checkbox" onclick="terms_changed(this)" name="recovery[]" value="<?php echo $row['product_code']; ?>"></td>
														<td><?php echo $i; ?></td>
														...
														<td>	
															...
															<ul class="list-inline m-0">
																<li class="list-inline-item">
																	<a href="all-deletedproduct-manager.php?recovery&code=<?php echo $row['product_code'];?>" onclick="return rec_confirmation();"><button class="btn btn-primary btn-sm rounded-0" type="button" title="Recovery"><i class="fas fa-trash-restore-alt"></i></button></a>
																</li>
															</ul>
														</td>
													</tr>
													...
													$i++;
															...
															$result = mysqli_query($connect, "SELECT * FROM product JOIN brand ON product.brand_name=brand.brand_name 
																							  WHERE product.cat_name='$cat_filter' AND product.product_status = 0 AND brand.brand_status=1");
												...
												<?php
														$i = 1;
														$result = mysqli_query($connect, "SELECT * FROM product JOIN brand ON product.brand_name=brand.brand_name WHERE product.product_status = 0 AND brand.brand_status=1");
										...
										<br>
										<button type="submit" name="recoverybtn" id="recoverybtn" class="btn btn-primary btn-block" onclick="rec_confirmation();" disabled>Recovery Selected Product</button>
										<br>
									</form>
								</div>
							</div>
...
<script type="text/javascript">
	...
	function rec_confirmation(){
		var option;
		option = confirm("Are you sure to recovery the product?");
		return option;
	}
</script>
...
?>
<?php
//recovery multiple products
if(isset($_GET['recoverybtn'])){
	$product = $_GET["recovery"];
	foreach($product as $id){
		mysqli_query($connect,"UPDATE product SET product_status = 1 WHERE product_code='$id'");
	}
?>
<script>
	swal({
    title: "The product is recovered!",
	type: "success"
			...
			$('.swal2-confirm').click(function(){
					window.location.href = 'all-deletedproduct-manager.php';
			});
</script>
<?php
}
...
if(isset($_GET["recovery"])) {
	$pcode = $_GET['code'];
	//update table and set product_status to 1
	mysqli_query($connect,"UPDATE product SET product_status = 1 WHERE product_code='$pcode'");
?>
<script>
	swal({
    title: "The product is recovered!",
