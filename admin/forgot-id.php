...
if(isset($_GET['reset'])){
	...
	$res = mysqli_query($connect,"select adm_id, adm_email,adm_pass,adm_name from admin where adm_email='$email'");
	...
	if($row != 0){ 
		...
		$id=$row['adm_id'];
		$message = "Dear ".$fname.",\n\nYour Admin ID is ".$id."\n\nThank you. \n\n\nPlease click the link below to login again.\n\nhttp://localhost/3L_Telecommunication/admin/login.php";
...
<head>
    ...
    <title>SB Admin 2 - Forgot Admin ID</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-2">Forgot Admin ID?</h1>
                                    ...
                                    <form class="user" autocomplete="off")>
                                        ...
                                        <input type="submit" name="reset" value="Submit" class="btn btn-primary btn-user btn-block">
                                    </form>
                                    <br>
                                    <div class="text-center">
