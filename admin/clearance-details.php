														...
														<td>	
															<ul class="list-inline m-0">
																<li class="list-inline-item">
																	<a href="view-clearance-details.php?view&code=<?php echo $detail_row['product_detail_code'];?>"><button class="btn btn-primary btn-sm rounded-0" type="button" title="View"><i class="fa fa-eye"></i></button></a>
																</li>
															</ul>
														</td>
													</tr>
