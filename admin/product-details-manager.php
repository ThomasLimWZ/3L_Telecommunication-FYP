            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        ?>
                            <a href="add-product-details-manager.php?add&code=<?php echo $row['product_code'];?>" class="btn btn-primary float-right veiwbutton">Add Product Details</a>
                        <?php
                        }
                        ?>
                    </div>
														...
														<td>	
															<ul class="list-inline m-0">
																<li class="list-inline-item">
																	<a href="view-product-details-manager.php?view&code=<?php echo $detail_row['product_detail_code'];?>"><button class="btn btn-primary btn-sm rounded-0" type="button" title="View"><i class="fa fa-eye"></i></button></a>
																</li>
																<li class="list-inline-item">
																	<a href="edit-product-details-manager.php?edit&code=<?php echo $detail_row['product_detail_code'];?>"><button class="btn btn-success btn-sm rounded-0" type="button" title="Edit"><i class="fa fa-edit"></i></button></a>
																</li>
                                                                <li class="list-inline-item">
                                                                    <a href="restock-product-manager.php?restock&code=<?php echo $detail_row['product_detail_code'];?>"><button class="btn btn-warning btn-sm rounded-0" type="button" title="Restock"><i class="fa fa-plus"></i></button></a>
                                                                </li>
															</ul>
														</td>
													</tr>
