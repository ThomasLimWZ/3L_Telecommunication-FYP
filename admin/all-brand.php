            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">All Brand</h1><a href="add-brand.php" class="btn btn-primary float-right veiwbutton">Add Brand</a>
                    </div>
										...
										<div class="row formtype">
											<div class="col-md-3">
												<div class="form-group">
													<label>Brand Status &nbsp;</label> <a href="all-brand.php"><i style="color:black;" class="fa">&#xf021;</i></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
														<?php
                                                            ...
                                                            {
                                                            ?>
                                                            <i><a href="all-brand.php?status&name=<?php echo $row['brand_name'];?>" 
