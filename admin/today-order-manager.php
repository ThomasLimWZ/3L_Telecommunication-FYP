										...
										<div class="row formtype">
											<div class="col-md-3">
												<div class="form-group">
													<label>Order Status &nbsp;</label> <a href="today-order-manager.php"><i style="color:black;" class="fa">&#xf021;</i></a>
											...
											?>
													...
													<td><?php echo $i;?></td>
														...
														<td>
                                                            ...
                                                            {
                                                            ?>
                                                            <i><a href="today-order-manager.php?status&code=<?php echo $row['payment_code'];?>" 
...
<script>
	...
	$('.swal2-confirm').click(function(){
		window.location.href = 'today-order-manager.php';
	});
