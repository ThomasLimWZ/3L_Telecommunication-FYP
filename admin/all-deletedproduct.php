								...
								<div class="col-lg-12">
										...
										<div class="row formtype">
											<div class="col-md-3">
												<div class="form-group">
													<label>Brand &nbsp;</label> <a href="all-deletedproduct.php"><i style="color:black;" class="fa">&#xf021;</i></a>
									...
									<form method="GET" action="">
										<div class="row formtype">
											<div class="col-md-3">
												<div class="form-group">
													<label>Category &nbsp;</label> <a href="all-deletedproduct.php"><i style="color:black;" class="fa">&#xf021;</i></a>
														...
														<td>	
															...
															<ul class="list-inline m-0">
																<li class="list-inline-item">
																	<a href="all-deletedproduct.php?recovery&code=<?php echo $row['product_code'];?>" onclick="return rec_confirmation();"><button class="btn btn-primary btn-sm rounded-0" type="button" title="Recovery"><i class="fas fa-trash-restore-alt"></i></button></a>
																</li>
															</ul>
														</td>
													</tr>
...
<script>
	...
	type: "success"
			...
			$('.swal2-confirm').click(function(){
					window.location.href = 'all-deletedproduct.php';
			});
</script>
<?php
}
