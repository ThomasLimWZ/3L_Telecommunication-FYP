            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">All Product</h1><a href="add-product.php" class="btn btn-primary float-right veiwbutton">Add Product</a>
                    </div>
								...
								<div class="col-lg-12">
										...
										<div class="row formtype">
											<div class="col-md-3">
												<div class="form-group">
													<label>Brand &nbsp;</label> <a href="all-product.php"><i style="color:black;" class="fa">&#xf021;</i></a>
									...
									<form method="GET" action="">
										<div class="row formtype">
											<div class="col-md-3">
												<div class="form-group">
													<label>Category &nbsp;</label> <a href="all-product.php"><i style="color:black;" class="fa">&#xf021;</i></a>
														...
														<td>	
															...
															<ul class="list-inline m-0">
																<li class="list-inline-item">
																	<a href="view-product.php?view&code=<?php echo $row['product_code'];?>"><button class="btn btn-primary btn-sm rounded-0" type="button" title="View"><i class="fa fa-eye"></i></button></a>
																</li>
																<li class="list-inline-item">
																	<a href="edit-product.php?edit&code=<?php echo $row['product_code'];?>"><button class="btn btn-success btn-sm rounded-0" type="button" title="Edit"><i class="fa fa-edit"></i></button></a>
																</li>
																<li class="list-inline-item">
																	<a href="all-product.php?del&code=<?php echo $row['product_code'];?>" onclick="return del_confirmation();"><button class="btn btn-danger btn-sm rounded-0" type="button" title="Delete"><i class="fa fa-trash"></i></button></a>
																</li>
																<li class="list-inline-item">
																	<a href="product-details.php?view&code=<?php echo $row['product_code'];?>"><button class="btn btn-info btn-sm rounded-0" type="button" title="Add product details"><i class="far fa-file-alt"></i></button></a>
																</li>
															</ul>
														</td>
													</tr>
