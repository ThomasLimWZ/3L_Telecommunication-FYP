							...
							<div class="row">
								<div class="col-lg-12">
									<form name="updateproduct" method="post" action="" enctype="multipart/form-data">
										...
										?>
										<br>
										<a href="product-details.php?view&code=<?php echo $row['product_code'];?>" class="btn btn-primary buttonedit ml-2">Back to Product Details</a>
										<a href="edit-product-details.php?edit&code=<?php echo $dcode;?>" class="btn btn-success buttonedit ml-2">Edit Product Detail</a>
									</form>
								</div>
							</div>
						</div>
