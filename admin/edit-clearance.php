											...
											?>
														<div>
															<table class="container">
																<tr>
																	<td class="image"><a href="update-clearimg.php?edit&code=<?php echo $pcode;?>&color=<?php echo $images['product_color1'];?>"><img src="product/<?=$images['product_img1']?>" width="200px" style="object-fit:contain;"></a></td>
															<?php
																if (empty($images['product_img2'])){}
																else{
															?>
																	<td class="image"><a href="update-clearimg.php?edit&code=<?php echo $pcode;?>&color=<?php echo $images['product_color2'];?>"><img src="product/<?=$images['product_img2']?>" width="200px" style="object-fit:contain;"></a></td>
															...
															?>
																	<td class="image"><a href="update-clearimg.php?edit&code=<?php echo $pcode;?>&color=<?php echo $images['product_color3'];?>"><img src="product/<?=$images['product_img3']?>" width="200px" style="object-fit:contain;"></a></td>
															<?php
																}
															?>
															<?php
															...
															?>
																	<td class="image"><a href="update-clearimg.php?edit&code=<?php echo $pcode;?>&color=<?php echo $images['product_color4'];?>"><img src="product/<?=$images['product_img4']?>" width="200px" style="object-fit:contain;"></a></td>
															<?php
																}
															?>
															<?php
															...
															?>
																	<td class="image"><a href="update-clearimg.php?edit&code=<?php echo $pcode;?>&color=<?php echo $images['product_color5'];?>"><img src="product/<?=$images['product_img5']?>" width="200px" style="object-fit:contain;"></a></td>
															<?php
																}
															?>
															<?php
															...
															?>
																	<td class="image"><a href="update-clearimg.php?edit&code=<?php echo $pcode;?>&color=<?php echo $images['product_color6'];?>"><img src="product/<?=$images['product_img6']?>" width="200px" style="object-fit:contain;"></a></td>
															<?php
																}
															?>
																</tr>
