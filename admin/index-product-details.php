            ...
            <div id="content">
                ...
                <div class="container-fluid">
					...
					<div class="page-wrapper">
														...
														<td>	
															<ul class="list-inline m-0">
                                                                <li class="list-inline-item">
                                                                    <a href="index-restock-product.php?restock&code=<?php echo $detail_row['product_detail_code'];?>"><button class="btn btn-warning btn-sm rounded-0" type="button" title="Restock"><i class="fa fa-plus"></i></button></a>
                                                                </li>
															</ul>
														</td>
													</tr>
                        ...
                        <br><br>
                        <a href="index.php" class="btn btn-primary buttonedit ml-2">Back to Dashboard</a>
					</div>
				</div>
			</div>
            <!-- /.container-fluid -->
