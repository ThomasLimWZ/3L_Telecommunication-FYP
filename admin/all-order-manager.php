										...
										<div class="row formtype">
											<div class="col-md-3">
												<div class="form-group">
													<label>Order Status &nbsp;</label> <a href="all-order-manager.php"><i style="color:black;" class="fa">&#xf021;</i></a>
											...
											?>
													...
													<td><?php echo $i;?></td>
														...
														<td>
                                                            ...
                                                            {
                                                            ?>
                                                            <i><a href="all-order-manager.php?status&code=<?php echo $row['payment_code'];?>" 
