							...
							<div class="row">
								<div class="col-lg-12">
									<form method="post" action="" name="myform" enctype="multipart/form-data" autocomplete="off" onsubmit="return validation()">
										...
										<a href="edit-product.php?edit&code=<?php echo $pcode;?>" class="btn btn-primary buttonedit ml-2">Back to Edit Product</a>
									</form>
								</div>
							</div>
						</div>
    ...
    <script>
        ...
        type: "success"
              ...
              $('.swal2-confirm').click(function(){
                    window.location.href = 'edit-product.php?edit&code=<?php echo $pcode;?>';
              });
    </script>
    <?php
                    }
