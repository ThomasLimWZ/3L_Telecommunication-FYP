							...
							<div class="row">
								<div class="col-lg-12">
									...
									<div class="row formtype">
										...
										<a href="index-product-details-manager.php?detail&code=<?php echo $row['product_code'];?>" class="btn btn-primary buttonedit ml-2">Back to List</a>
									</form>
								</div>
							</div>
						</div>
	...
	swal({
		...
		type: "success"},function(isConfirm){
			  ...
			  $('.swal2-confirm').click(function(){
					window.location.href = 'index-manager.php';
			  });  
