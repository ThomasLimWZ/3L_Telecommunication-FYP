									...
									<form name="addnewproduct" method="post" action="" enctype="multipart/form-data" autocomplete="off" onsubmit="return validation()" onchange="createInputText()">
										...
										<div class="row formtype">
											...
											<div class="col-md-4" id="cap">
												<div class="form-group">
												<label id="label"></label><span id="req"></span><input id="capacity" class="form-control" type="hidden" name="prod_cap" placeholder="8+128GB OR 128GB" value="<?php echo isset($_POST["prod_cap"]) ? $_POST["prod_cap"] : ''; ?>" oninput="this.value = this.value.replace(/[^0-9.+.G.T.B.m]/g, '').replace(/(\..*)\./g, '$1');">
												</div>
											</div>
										</div>
										<script type="text/javascript">
