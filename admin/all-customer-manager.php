											...
											<?php
												...
												?>		
													<tr>
														...
														<td>
														<a href="view-customer-manager.php?view&id=<?php echo $row['cus_id'];?>"><button class="btn btn-primary btn-sm rounded-0" type="button" title="View"><i class="fa fa-eye"></i></button></a>
														</td>
													</tr>
													<?php
													$i++;
