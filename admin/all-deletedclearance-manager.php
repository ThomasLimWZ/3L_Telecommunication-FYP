								...
								<div class="col-lg-12">
										...
										<div class="row formtype">
											<div class="col-md-3">
												<div class="form-group">
													<label>Brand &nbsp;</label> <a href="all-deletedclearance-manager.php"><i style="color:black;" class="fa">&#xf021;</i></a>
									...
									<form method="GET" action="">
										<div class="row formtype">
											<div class="col-md-3">
												<div class="form-group">
													<label>Category &nbsp;</label> <a href="all-deletedclearance-manager.php"><i style="color:black;" class="fa">&#xf021;</i></a>
													...
													<tr>
														...
														<td>	
															...
															<li class="list-inline-item">
																	<a href="all-deletedclearance-manager.php?rec&code=<?php echo $row['clearance_code'];?>" onclick="return del_confirmation();"><button class="btn btn-primary btn-sm rounded-0" type="button" title="Recovery"><i class="fas fa-trash-restore-alt"></i></button></a>
																</li>
															</ul>
														</td>
													</tr>
...
<script>
	...
	type: "success"
			...
			$('.swal2-confirm').click(function(){
					window.location.href = 'all-deletedclearance-manager.php';
			});
</script>
<?php
}
