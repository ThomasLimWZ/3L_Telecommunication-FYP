            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Product Details</h1><?php include("connection.php"); ?>
                    </div>
							...
							<div class="row">
								<div class="col-lg-12">
									<form name="updateproduct" method="post" action="" enctype="multipart/form-data">
										<div class="row formtype">
											<div class="col-md-4">
												<div class="form-group">
													<p>Name<input class="form-control" type="text" name="prod_name" value="<?php echo $row['product_name'];?>" disabled></p>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group">
													<p>Price<input class="form-control" type="text" name="prod_price" value="RM <?php 
													if(count($price) > 1){
														echo $min." - RM ".$max;
													}
													else{
										...
										<div class="row formtype">
											<div class="col-md-4">
												<div class="form-group">
													...
													<textarea class="form-control validate" name="prod_descrip" rows="10" disabled><?php echo $row['product_descrip'];?></textarea>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group">
													<label>Brand</label>
													<input class="form-control" name="brand" value="<?php echo $row['brand_name']; ?>" disabled>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group">
													...
													<input class="form-control" name="category" value="<?php echo $row['cat_name']; ?>" disabled>
												</div>
											</div>
										</div>
										...
										?>
										<a href="edit-product.php?edit&code=<?php echo $row['product_code'];?>" class="btn btn-success buttonedit ml-2">Edit</a>
									</form>
								</div>
							</div>
						</div>
