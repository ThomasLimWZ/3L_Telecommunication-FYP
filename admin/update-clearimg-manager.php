            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Select New Clearance Image</h1>
                    </div>
                    ...
                    <?php
                        if(isset($_GET["edit"])){
                            ...
                            $result = mysqli_query($connect, "SELECT * FROM clearance WHERE clearance_product_code='$pcode'");
                            $row = mysqli_fetch_assoc($result);

                            $ccode = $row['clearance_code'];
					...
					<div class="page-wrapper">
						<div class="content container-fluid">
                            <h4><?php echo $row['clearance_product_name']; ?></h4>
      ...
      swal({
            ...
            type: "success"
                ...
                $('.swal2-confirm').click(function(){
                        window.location.href = 'view-clearance-manager.php?view&code='+code;
                });
