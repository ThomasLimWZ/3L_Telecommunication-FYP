								...
								<div class="col-lg-12">
									<form name="vieworder" method="post" action="" enctype="multipart/form-data">
										...
										<div class="row formtype">
											...
											<div class="col-md-4">
														<div class="form-group">
														<p>Contact Number<input class="form-control" type="text" name="ship_phone" value="<?php echo $ship_row['contact_phone'];?>" disabled></p>
														</div>
											</div>
											<?php
										...
										<br/>
										<button class="btn btn-primary buttonedit ml-2" onclick="window.history.go(-1); return false;">Back To Order List</button>
										<a href="edit-order-manager.php?edit&code=<?php echo $pay_row['payment_code'];?>" class="btn btn-success buttonedit ml-2">Edit</a>
									</form>
