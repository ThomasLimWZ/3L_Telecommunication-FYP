							...
							<div class="row">
								<div class="col-lg-12">
									...
									<div class="row formtype">
										...
										<a href="product-details.php?view&code=<?php echo $row['product_code'];?>" class="btn btn-primary buttonedit ml-2">Back to Detail List</a>
									</form>
								</div>
							</div>
						</div>
...
if(isset($_POST["savebtn"])){
	...
	mysqli_query($connect,"UPDATE product_detail SET product_stock1='$s1', product_stock2='$s2', product_stock3='$s3',product_stock4='$s4',product_stock5='$s5',product_stock6='$s6' WHERE product_detail_code='$dcode'");
	...
	swal({
		...
		type: "success"},function(isConfirm){
			  ...
			  $('.swal2-confirm').click(function(){
					window.location.href = 'product-details.php?view&code=<?php echo $pcode;?>';
			  });  
