                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
						...
						<div class="card text-white bg-white o-hidden border-left-success h-100">
								<div class="card-body">
									...
									<div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo $row_admin; ?> </div>
								</div>
								<a class="card-footer clearfix small z-1" href="all-admin-manager.php">
						...
						<div class="card text-white bg-white o-hidden border-left-primary h-100">
								...
								<a class="card-footer clearfix small z-1" href="all-customer-manager.php">
									<span class="float-left">View Details</span>
									<span class="float-right">
										<i class="fa fa-angle-right"></i>
									</span>
						...
						<div class="card text-white bg-white o-hidden border-left-info h-100">
								...
								<a class="card-footer clearfix small z-1" href="all-brand-manager.php">
									<span class="float-left">View Details</span>
									<span class="float-right">
										<i class="fa fa-angle-right"></i>
									</span>
						...
						<div class="card text-white bg-white o-hidden border-left-warning h-100">
								...
								<a class="card-footer clearfix small z-1" href="all-product-manager.php">
									<span class="float-left">View Details</span>
									<span class="float-right">
										<i class="fa fa-angle-right"></i>
									</span>
					...
					<!-- Total Sales in current year -->
						...
						<div class="card text-white bg-white o-hidden border-left-danger h-100">
								...
								<a class="card-footer clearfix small z-1" href="all-sales-currentyear-manager.php">
									<span class="float-left">View Details</span>
									<span class="float-right">
										<i class="fa fa-angle-right"></i>
									</span>
					...
					<!-- Total ORDER past 7 days -->
						...
						<div class="card text-white bg-white o-hidden border-left-secondary h-100">
								...
								<a class="card-footer clearfix small z-1" href="seven-order-manager.php">
									<span class="float-left">View Details</span>
									<span class="float-right">
										<i class="fa fa-angle-right"></i>
									</span>
                        ...
                        <div class="col-xl-3 col-sm-6 mb-3">
							<div class="card text-white bg-white o-hidden border-left-warning h-100">
								...
								<a class="card-footer clearfix small z-1" href="yesterday-order-manager.php">
									<span class="float-left">View Details</span>
									<span class="float-right">
										<i class="fa fa-angle-right"></i>
									</span>
						...
						<div class="card text-white bg-white o-hidden border-left-primary h-100">
								...
								<a class="card-footer clearfix small z-1" href="today-order-manager.php">
									<span class="float-left">View Details</span>
									<span class="float-right">
										<i class="fa fa-angle-right"></i>
									</span>
												...
												?>
													<tr>
														...
														<td>	
															...
															<ul class="list-inline m-0">
																<li class="list-inline-item">
																	<a href="index-product-details-manager.php?detail&code=<?php echo $row['product_code'];?>"><button class="btn btn-warning btn-sm rounded-0" type="button" title="Restock"><i class="fa fa-plus"></i></button></a>
																</li>
															</ul>
														</td>
													</tr>
