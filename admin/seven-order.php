            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Last 7 Days' Order</h1>
                    </div>
                    <!-- Content Row -->
										...
										<div class="row formtype">
											<div class="col-md-3">
												<div class="form-group">
													<label>Order Status &nbsp;</label> <a href="seven-order.php"><i style="color:black;" class="fa">&#xf021;</i></a>
											...
											<?php
												if(isset($_GET["filterbtn"])){
													...
													$result = mysqli_query($connect, "SELECT * FROM payment JOIN shipping ON payment.payment_code=shipping.payment_code
																					  WHERE shipping.delivery_status='$shipping_filter' AND delivery_status!=3 AND date(payment.payment_date)>=(DATE(NOW()) - INTERVAL 7 DAY)");
											...
											?>
													...
													<td><?php echo $i;?></td>
														...
														<td>
                                                            ...
                                                            {
                                                            ?>
                                                            <i><a href="seven-order.php?status&code=<?php echo $row['payment_code'];?>" 
												...
												<?php
													...
													$result = mysqli_query($connect, "SELECT * FROM payment INNER JOIN customer ON payment.cus_email=customer.cus_email
																					  WHERE date(payment.payment_date)>=(DATE(NOW()) - INTERVAL 7 DAY)");	
												?>
												<thead>
														<tr>
															<th>No.</th>
...
<script>
	...
	$('.swal2-confirm').click(function(){
		window.location.href = 'seven-order.php';
	});
