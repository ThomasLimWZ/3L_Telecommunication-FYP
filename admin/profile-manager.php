									...
									<div class="col-md-3 col-xl-2">
										<div class="card">
											...
											<div class="list-group list-group-flush" role="tablist">
												<a class="list-group-item list-group-item-action active" href="profile-manager.php">
													Account
												</a>
												<a class="list-group-item list-group-item-action" href="password-manager.php">
													Password
												</a>
											</div>
										</div>
												...
												<div class="card">
													...
													<div class="card-body">
														<h5 class="card-title d-flex justify-content-between">
															...
															<a href="edit-profile-manager.php"><i class="fa fa-edit mr-1"></i>Edit</a>
														</h5>
														...
														?>
															<a href="update-profilepic-manager.php">
																<div class ="circle">
																	<?php
