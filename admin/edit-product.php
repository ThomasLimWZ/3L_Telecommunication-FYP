							...
							<div class="row">
								<div class="col-lg-12">
									<form name="updateproduct" method="post" action="" enctype="multipart/form-data" autocomplete="off">
											...
											?>
														<div>
															<table class="container">
																<tr>
																	<td class="image"><a href="update-productimg.php?edit&code=<?php echo $pcode;?>&color=<?php echo $images['product_color1'];?>"><img src="product/<?=$images['product_img1']?>" width="200px" style="object-fit:contain;"></a></td>
															<?php
																if (empty($images['product_img2'])){
															?>

																	<td class="image"><a href="add-color.php?add&code=<?php echo $pcode;?>&color=<?php echo 'product_color2';?>"><img src="product/emptycolor.png" width="200px" style="object-fit:contain;"></a></td>
															...
															?>
																	<td class="image"><a href="update-productimg.php?edit&code=<?php echo $pcode;?>&color=<?php echo $images['product_color2'];?>"><img src="product/<?=$images['product_img2']?>" width="200px" style="object-fit:contain;"></a></td>
															...
															?>
																	...
																	<td class="image"><a href="add-color.php?add&code=<?php echo $pcode;?>&color=<?php echo 'product_color3';?>"><img src="product/emptycolor.png" width="200px" style="object-fit:contain;"></a></td>
																	
															<?php
																}
																else{
															?>
																	<td class="image"><a href="update-productimg.php?edit&code=<?php echo $pcode;?>&color=<?php echo $images['product_color3'];?>"><img src="product/<?=$images['product_img3']?>" width="200px" style="object-fit:contain;"></a></td>
															<?php
																}
															?>
															<?php
															...
															?>
																	...
																	<td class="image"><a href="add-color.php?add&code=<?php echo $pcode;?>&color=<?php echo 'product_color4';?>"><img src="product/emptycolor.png" width="200px" style="object-fit:contain;"></a></td>
																	
															<?php
																}
																else{
															?>
																	<td class="image"><a href="update-productimg.php?edit&code=<?php echo $pcode;?>&color=<?php echo $images['product_color4'];?>"><img src="product/<?=$images['product_img4']?>" width="200px" style="object-fit:contain;"></a></td>
															<?php
																}
															?>
															<?php
															...
															?>
																	...
																	<td class="image"><a href="add-color.php?add&code=<?php echo $pcode;?>&color=<?php echo 'product_color5';?>"><img src="product/emptycolor.png" width="200px" style="object-fit:contain;"></a></td>
																	
															<?php
																}
																else{
															?>
																	<td class="image"><a href="update-productimg.php?edit&code=<?php echo $pcode;?>&color=<?php echo $images['product_color5'];?>"><img src="product/<?=$images['product_img5']?>" width="200px" style="object-fit:contain;"></a></td>
															<?php
																}
															?>
															<?php
															...
															?>
																	...
																	<td class="image"><a href="add-color.php?add&code=<?php echo $pcode;?>&color=<?php echo 'product_color6';?>"><img src="product/emptycolor.png" width="200px" style="object-fit:contain;"></a></td>
																	
															<?php
																}
																else{
															?>
																	<td class="image"><a href="update-productimg.php?edit&code=<?php echo $pcode;?>&color=<?php echo $images['product_color6'];?>"><img src="product/<?=$images['product_img6']?>" width="200px" style="object-fit:contain;"></a></td>
															<?php
																}
															?>
																</tr>
										...
										?>
										<a href="product-details.php?view&code=<?php echo $pcode;?>" class="btn btn-success buttonedit ml-2">Price and Capacity</a>
										<?php
										}
										else{
											?>
											<a href="product-details.php?view&code=<?php echo $pcode;?>" class="btn btn-success buttonedit ml-2">Price Details</a>
										<?php
										}
										?>
									</form>
