...
document.getElementById("cat").classList.add('active');
		...
		<div class="container" style="text-align:center;">
			...
			<ul class="sorting">
				...
				<li id="child1" class="sort_child"><h6><a class="child_link" id="link1" href="brand-category-login.php?view&brand=<?php echo $brand;?>&cat=<?php echo $cat;?>">Latest</a></h6></li>
		...
		<script>
			$(function() {
				$('#link2').click(function() {
					window.location.href = 'brand-category-login.php?view&brand=<?php echo $brand;?>&cat=<?php echo $cat;?>&sortName&sort_type=<?php echo $new_sort_type;?>';
				});
			});
			$(function() {
				$('#link3').click(function() {
					window.location.href = 'brand-category-login.php?view&brand=<?php echo $brand;?>&cat=<?php echo $cat;?>&sortPrice&sortPrice_type=<?php echo $new_sortPrice_type;?>';
				});
			});
		</script>
					...
					<div class="col-6 col-md-4 col-lg-3">
						<div class="product product-2">
							<figure class="product-media">
								<a href="product-details-login.php?view&code=<?php echo $row1['product_code']; ?>" style="height:300px; object-fit:contain;">
									<img src="admin/product/<?=$imgrow['product_img1']?>" alt="Product image" class="product-image">
								</a>
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product-details-login.php?view&code=<?php echo $row1['product_code']; ?>"><?php echo $row1['product_name']; ?></a></h3><!-- End .product-title -->
