                        ...
                        <div class="container intro-content">
                            <div class="row justify-content-end">
                                <div class="col-auto col-sm-7 col-md-6 col-lg-5">
                                    ...
                                    <h1 class="intro-title">Apple<br>iPhone 13 Pro </h1><!-- End .intro-title -->
                    ...
                    <div class="row">
                        ...
                        ?>
                            <div class="col-6 col-sm-4 col-lg-2" style="margin:auto;">
                                <a href="category-products.php?view&cat=<?php echo $catRow['cat_name'];?>" class="cat-block">
                                    <figure>
                                        <span>
            ...
            <div class="container for-you">
                <div class="heading heading-flex mb-3">
                   ...
                   <div class="heading-right">
                        <a href="all-products.php" class="title-link">View All Recommendation <i class="icon-long-arrow-right"></i></a>
                ...
                <div class="products">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-6 col-md-4 col-lg-3">
                            <div class="product product-2" style="border:1px solid #e6e6e6;">
                                <figure class="product-media">
                                    <a href="product-details.php?view&code=<?php echo $rec_row['product_code']; ?>">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product-details.php?view&code=<?php echo $rec_row['product_code']; ?>"><?php echo $rec_row['product_name']; ?></a></h3><!-- End .product-title -->
