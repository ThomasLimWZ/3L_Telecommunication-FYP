	...
	border-bottom: 0;
		...
		?>
			<ul class="sorting">
				...
				<li id="child1" class="sort_child"><h6><a class="child_link" id="link1" href="search-products-login.php?search&searchResult=<?php echo $things;?>">Latest</a></h6></li>
			...
			<script>
				$(function() {
					$('#link2').click(function() {
						window.location.href = 'search-products-login.php?search&searchResult=<?php echo $things;?>&sortName&sort_type=<?php echo $new_sort_type;?>';
					});
				});
				$(function() {
					$('#link3').click(function() {
						window.location.href = 'search-products-login.php?search&searchResult=<?php echo $things;?>&sortPrice&sortPrice_type=<?php echo $new_sortPrice_type;?>';
					});
				});
			</script>
					...
					<div class="col-6 col-md-4 col-lg-3">
						<div class="product product-2">
							<figure class="product-media">
								<a href="product-details-login.php?view&code=<?php echo $row1['product_code']; ?>">
