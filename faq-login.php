<?php include("header-login.php"); ?>
		...
		<div class="page-content">
			<div class="container">
                ...
                <h2 class="title text-center mb-3">Orders & Payment</h2><!-- End .title -->
        		...
        		<div class="accordion accordion-rounded" id="accordion-3">
						...
						<div class="card-header" id="heading3-2">
							<h2 class="card-title">
								<a class="collapsed" role="button" data-toggle="collapse" href="#collapse3-2" aria-expanded="false" aria-controls="collapse3-2">
									What shipping options offer by 3L?
					            </a>
					        </h2>
					    </div><!-- End .card-header -->
					...
					<div class="card card-box card-sm bg-light">
					   ...
					   <div id="collapse3-5" class="collapse" aria-labelledby="heading3-5" data-parent="#accordion-3">
							<div class="card-body">
								Yes, the delivery address can be changed before the order send out by send an email to 3L@gmail.com.
					        </div><!-- End .card-body -->
					    </div><!-- End .collapse -->
					</div><!-- End .card -->
				</div><!-- End .accordion -->
				...
				<h2 class="title text-center mb-3">WARRANTY</h2><!-- End .title -->
        		<div class="accordion accordion-rounded" id="accordion-5">
					<div class="card card-box card-sm bg-light">
					   ...
					   <div id="collapse5-1" class="collapse" aria-labelledby="heading5-1" data-parent="#accordion-5">
							<div class="card-body">
								The warranty documents will be sent with product package.
					        </div><!-- End .card-body -->
					    </div><!-- End .collapse -->
					</div><!-- End .card -->
					...
					<div class="card card-box card-sm bg-light">
					   ...
					   <div id="collapse5-2" class="collapse" aria-labelledby="heading5-2" data-parent="#accordion-5">
							<div class="card-body">
								Follow the steps in the warranty documents to claim warranty.
					        </div><!-- End .card-body -->
					    </div><!-- End .collapse -->
					</div><!-- End .card -->
				</div><!-- End .accordion -->
